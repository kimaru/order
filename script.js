...
// Clean diagnostic tracker
console.log("Store script initialized. Parsing URL variables...");
...
try {
  ...
  if (rawParam) {
    ...
    console.log("Successfully unpacked inventory data:", storeData);
    renderProducts();
  } else {
    document.getElementById('products-list').innerHTML = "<p style='text-align:center;'>No products loaded. Please use the link generated by your Merchant Dashboard.</p>";
  }
} catch (err) {
  console.error("Data reading crash:", err);
  document.getElementById('products-list').innerHTML = "<p style='text-align:center; color:red;'>Error reading digital store data format.</p>";
}
...
function renderProducts() {
  ...
  storeData.items.forEach((item, index) => {
    ...
    card.innerHTML = `
      <img class="product-thumb" src="${imgSrc}" onerror="this.src='https://placehold.co/100x100?text=No+Image';">
